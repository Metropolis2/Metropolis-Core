...
macro_rules! add_null_road_leg_columns {
    ($df:ident) => {
        add_null_const!($df, "road_leg_count", DataType::UInt64);
        add_null_const!($df, "nb_agents_at_least_one_road_leg", DataType::UInt64);
        add_null_const!($df, "nb_agents_all_road_legs", DataType::UInt64);
...
macro_rules! add_null_virtual_leg_columns {
    ($df:ident) => {
        add_null_const!($df, "virtual_leg_count", DataType::UInt64);
        add_null_const!($df, "nb_agents_at_least_one_virtual_leg", DataType::UInt64);
        add_null_const!($df, "nb_agents_all_virtual_legs", DataType::UInt64);
...
impl<T: TTFNum> ToPolars for AggregateResults<T> {
    fn to_dataframe(self) -> Result<DataFrame> {
        ...
        if let Some(trip_results) = self.mode_results.trip_modes {
            ...
            if let Some(dep_time_rmse) = trip_results.dep_time_rmse {
                ...
                add_null_const!(df, "trip_dep_time_rmse", DataType::Float64);
            }
            ...
            add_null_const!(df, "trip_count", DataType::UInt64);
        ...
        if let Some(cst_results) = self.mode_results.constant {
            ...
            add_null_const!(df, "constant_count", DataType::UInt64);
    ...
    fn schema() -> ArrowSchema {
        ...
        add_cst_to_fields!(fields, "trip_count", ArrowDataType::UInt64);
        add_distr_to_fields!(fields, "trip_departure_time");
        add_distr_to_fields!(fields, "trip_arrival_time");
        add_distr_to_fields!(fields, "trip_travel_time");
        add_distr_to_fields!(fields, "trip_utility");
        add_distr_to_fields!(fields, "trip_expected_utility");
        add_distr_to_fields!(fields, "trip_dep_time_shift");
        add_cst_to_fields!(fields, "trip_dep_time_rmse", ArrowDataType::Float64);
        add_cst_to_fields!(fields, "road_leg_count", ArrowDataType::UInt64);
        add_cst_to_fields!(
            fields,
            "nb_agents_at_least_one_road_leg",
            ArrowDataType::UInt64
        );
        add_cst_to_fields!(fields, "nb_agents_all_road_legs", ArrowDataType::UInt64);
        add_distr_to_fields!(fields, "road_leg_count_by_agent");
        add_distr_to_fields!(fields, "road_leg_departure_time");
        add_distr_to_fields!(fields, "road_leg_arrival_time");
        add_distr_to_fields!(fields, "road_leg_road_time");
        add_distr_to_fields!(fields, "road_leg_in_bottleneck_time");
        add_distr_to_fields!(fields, "road_leg_out_bottleneck_time");
        add_distr_to_fields!(fields, "road_leg_travel_time");
        add_distr_to_fields!(fields, "road_leg_route_free_flow_travel_time");
        add_distr_to_fields!(fields, "road_leg_global_free_flow_travel_time");
        add_distr_to_fields!(fields, "road_leg_route_congestion");
        add_distr_to_fields!(fields, "road_leg_global_congestion");
        add_distr_to_fields!(fields, "road_leg_length");
        add_distr_to_fields!(fields, "road_leg_edge_count");
        add_distr_to_fields!(fields, "road_leg_utility");
        add_distr_to_fields!(fields, "road_leg_exp_travel_time");
        add_distr_to_fields!(fields, "road_leg_exp_travel_time_rel_diff");
        add_distr_to_fields!(fields, "road_leg_exp_travel_time_abs_diff");
        add_cst_to_fields!(
            fields,
            "road_leg_exp_travel_time_diff_rmse",
            ArrowDataType::Float64
        );
        add_distr_to_fields!(fields, "road_leg_length_diff");
        add_cst_to_fields!(fields, "virtual_leg_count", ArrowDataType::UInt64);
        add_cst_to_fields!(
            fields,
            "nb_agents_at_least_one_virtual_leg",
            ArrowDataType::UInt64
        );
        add_cst_to_fields!(fields, "nb_agents_all_virtual_legs", ArrowDataType::UInt64);
        add_distr_to_fields!(fields, "virtual_leg_count_by_agent");
        add_distr_to_fields!(fields, "virtual_leg_departure_time");
        add_distr_to_fields!(fields, "virtual_leg_arrival_time");
        add_distr_to_fields!(fields, "virtual_leg_travel_time");
        add_distr_to_fields!(fields, "virtual_leg_global_free_flow_travel_time");
        add_distr_to_fields!(fields, "virtual_leg_global_congestion");
        add_distr_to_fields!(fields, "virtual_leg_utility");
        add_cst_to_fields!(fields, "constant_count", ArrowDataType::UInt64);
